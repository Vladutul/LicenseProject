...
class serialConnectionBackend():
    ...
    def send_data(self, data):
        if self.ser and self.ser.is_open and data is not '' and data is not None:
            try:
                ...
                print(f"Serial write/read failed: {e}")
        else:
            print("Serial port not open, connected, data is empty, or not Arduino COM port.")
        return None
